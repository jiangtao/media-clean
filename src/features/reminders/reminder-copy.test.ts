...
describe('reminder copy', () => {
  ...
  it('derives copy from the latest scan summary', () => {
    expect(
      ...
      detail: '本次扫描共检查 312 项媒体，其中 6 项建议清理、12 项建议复核，保留和清理页里还有 4 项待处理。',
    });
  });
  ...
  it('builds english reminder copy and localizes the default reminder title', () => {
    expect(
      ...
      detail:
        'This scan checked 120 media items: 2 suggested for cleanup, 1 suggested for review, and 0 still waiting in keep & clean.',
    });
  });
});
