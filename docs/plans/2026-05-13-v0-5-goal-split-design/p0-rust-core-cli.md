...
1. [Native Engine 主线方案调研](../../research/native-engine-options.md)
2. [桌面 / Skill 优先的本地识别与 LLM 路线](../../research/desktop-skill-local-llm-recognition.md)
3. [Rust-first 项目分层与发包管理](../../research/project-layering-and-packaging.md)
4. [v0.5 后续目标拆分决策记录](../../research/v0-5-follow-up-goal-split.md)
