...
1. [i18n 资源目录方案](../../research/i18n-resource-layout.md)
2. [主题 Token 与 Tailwind 复用方案](../../research/theme-token-tailwind-strategy.md)
3. [v0.5 后续目标拆分决策记录](../../research/v0-5-follow-up-goal-split.md)
